...
const dino1 = {
  ...
  */
  ...
  lower = arr.animal_name.toLowerCase();
  ...
  The zoos are concenred about animals with a lower population count. Find out which animals have a population less than 5.
    ...
    */
    ...
    function checkPop(arr){
      if(arr.population < 5){
  lowPopulation.push(arr);
      };
    } 
  zooAnimals.filter(checkPop);
  ...
  */
  let populationTotal = zooAnimals.reduce((cv,animals,index,zooAnimal) => {
      return cv += animals.population
  },0)
